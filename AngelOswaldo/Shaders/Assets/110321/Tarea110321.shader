Shader "Custom/Tarea110321"
{
    Properties
    {
        _Color("Color", Color) = (1,1,1,1)
        _Color2("Color Ojos", Color) = (1,1,1,1)
        ...
        SubShader
        {
            ...
            void surf(Input IN, inout SurfaceOutputStandard o)
            {
                ...
                fixed4 Ojos = tex2D(_MainTex2, IN.uv_MainTex) * _Color2;
                o.Albedo = c.rgb;
                ...
                o.Emission = colorReflect * 3.0 * gray * _rainIntensity + edge * float4(1.0, 0.2, 0.2, 1.0) * 5.0 * _edgeIntensity + Ojos *5.0;
